...
def ridge_test(stim, resp, alpha, singcutoff=1e-10, normalpha=False):
...
def ridge_corr_test(Rstim, Pstim, Rresp, Presp, alphas, normalpha=False, corrmin=0.2,
...
def bootstrap_ridge_test(Rstim, Rresp, Pstim, Presp, alphas, nboots, chunklen, nchunks,
